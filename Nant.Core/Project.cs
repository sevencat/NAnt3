...
namespace NAnt.Core
{
    ...
    public class Project
    {
        ...
        [NonSerialized()]
        private XmlNamespaceManager
            _nsMgr = new XmlNamespaceManager(new NameTable()); //used to map "nant" to default namespace.
        ...
        public void Execute(string targetName, bool forceDependencies)
        {
            ...
            else
            {
                ...
                System.Collections.Generic.Dictionary<string, Target> targets =
                    new System.Collections.Generic.Dictionary<string, Target>();
        ...
        internal void InitializeProjectDocument(XmlDocument doc)
        {
            ...
            foreach (XmlNode childNode in doc.DocumentElement.ChildNodes)
            {
                ...
                if (childNode.LocalName.Equals(TargetXml) &&
            ...
            foreach (XmlNode childNode in doc.DocumentElement.ChildNodes)
            {
                ...
                if (!(childNode.NodeType == XmlNodeType.Element) ||
                    !childNode.NamespaceURI.Equals(NamespaceManager.LookupNamespace("nant")) ||
                    childNode.LocalName.Equals(TargetXml))
                {
                    continue;
                }
        ...
        private void UpdateTargetFrameworkProperties()
        {
            ...
            Properties["nant.settings.currentframework.frameworkdirectory"] =
                TargetFramework.FrameworkDirectory.FullName;
            ...
            Properties["nant.settings.currentframework.frameworkassemblydirectory"] =
                TargetFramework.FrameworkAssemblyDirectory.FullName;
        ...
        /// </exception>
        private void TopologicalTargetSort(string root, TargetCollection targets, Hashtable state, Stack visiting,
            TargetCollection executeTargets)
        {
